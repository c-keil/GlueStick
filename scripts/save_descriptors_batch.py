...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='save descriptors')
    ...
    image_files = image_files[::skip] #skip every other
    print("Running on {} images".format(len(image_files)))
    assert(len(image_files)>0)

    features_name = "gluestick_skip{}".format(skip)
    ...
    for img1_fname in tqdm(image_files[1:]):
        ...
        matched_lines_junc_idx1 = lines_junc_idx1[match_indices]
